...
PAGE 1 : 
   ...
   RAML4      : origin = 0x00C000, length = 0x001780     //length:1d80--->>>1780  
   RAML5      : origin = 0x00D780, length = 0x000A00     //Dd80--->>>D780   400-->>>A00
   RAML6      : origin = 0x00E280, length = 0x000d00    
...
SECTIONS
{
   ...
   /* use to store fft */
   CFFTdata1        : > RAML7,     PAGE = 1, ALIGN(1024) /*128个点--512  64个点对应256*/
   CFFTdata2        : > RAML5,     PAGE = 1, ALIGN(1024)
   CFFTdata3        : > RAML6,     PAGE = 1, ALIGN(1024)
   CFFTdata4        : > RAML7,     PAGE = 1, ALIGN(1024)
   
   /*
   RFFTdata1 		: > RAML7, 	   PAGE = 1, ALIGN(256) 
